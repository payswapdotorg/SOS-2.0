#!/usr/bin/env node
/**
 * The test-runner dispatch of @sos-2/tests-real-persistence (Work Order
 * P17-A): the deterministic reference-mode suite runs by default
...
console.log(`[tests-real-persistence] running the ${label} suite (${config})`);
