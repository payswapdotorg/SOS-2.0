/**
 * @sos-2/browser-bridge — the OPTIONAL browser bridge (Work Order P11):
 * the §4 tier-4 ('extension') adapter contract bridging a browser
 * extension onto the companion/harness surface.
 *
 ...
 *   authorities).
 * - Honest statuses: NOT_YET_CONNECTED while no real extension exists
 *   (the P8 connection vocabulary, consumed); the explicit simulated
 *   marker when the deterministic reference transport backs the bridge.
 *
